...
<form id="userEditForm" action="{{route('admin.saveagreement')}}" method="post">
    ...
    <label for="name1">Name of party 1</label>
    <input type="text" id="name" name="name1" required >

    <label for="name2">Name of party 2</label>
    <input type="text" id="email" name="name2" required>
    
    <label for="company">Company Name</label>
    <input type="text" id="email" name="company" required>
